...
<div class="col align-selft-start">
  ...
  <div class="container-fluid">
    <div class="p-3 mb-2 bg-light text-dark"><form action="scannerprocess.php" method=POST>
    <table border="3" width="25%">
      <label for="inputlg">Barcode No.</label>
      <th>Enter Barcode</th><br>
      <td><input class="form-control input-lg" size="30" type="text" name="barcode" onmouseover="this.focus();" autocomplete="of
        "/></td>
    </table></div></form>
...
echo '<form action="scanpurchase.php" method="post">
